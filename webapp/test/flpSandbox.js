		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#itorogeldepositbooklet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogeldepositbooklet-display": {
								"semanticObject": "itorogeldepositbooklet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.depositbooklet",
									"url": sap.ui.require.toUrl("it/orogel/depositbooklet")
								}
							}
						}
					}
